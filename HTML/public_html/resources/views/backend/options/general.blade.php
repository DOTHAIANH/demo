						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="content[facebook]" value="{{ @$content->facebook }}">
								</div>
								<div class="form-group">
									<label for="">Link Facebook</label>
									<input type="text" class="form-control" name="content[link_facebook]" value="{{ @$content->link_facebook }}">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="">Script</label>
									<textarea name="content[des_company]" class="form-control" rows="10">{!! @$content->des_company !!}</textarea>
								</div>
							</div>
						</div>
					</div>
