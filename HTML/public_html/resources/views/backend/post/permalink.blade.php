...
<span id="sample-permalink">
    <a class="permalink" target="_blank" href="{{ route('single.blog', $data->slug) }}">
    	<span class="default-slug">
    		{{ route('news') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ route('news') }}">
