        ...
        <div class="box box-primary">
            <div class="box-body">
               	...
               	<form action="{{ route('users.update', $data->id) }}" method="POST" autocomplete="off">
	           		...
	           		<div class="col-md-5">
		                ...
		                <div class="form-group">
		                    ...
		                    <select name="roles" class="form-control" >
								...
								<option value="{{$role->id}}" @if($userRole == $role->name) selected="selected" @endif>{{$role->name}}</option>
		                        @endforeach
		                    </select>
		                </div>
		                @endif
		            ...
		            <div class="col-sm-5">
		            	<div class="form-group">
						    <select multiple="multiple" size="10" name="permission[]" id="permission">
...
jQuery(document).ready(function($) {
	...
	$('#permission').bootstrapDualListbox();
});
</script>
@endsection