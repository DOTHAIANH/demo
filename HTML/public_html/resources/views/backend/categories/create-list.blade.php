	                            ...
	                            @foreach ($data as $item)
	                                <tr>
	                                    ...
	                                    <td>
	                                    	...
	                                    	<a href="{{ url('news/'.$item->slug) }}" target="_blank">
	                                    		<i class="fa fa-eye" aria-hidden="true"></i> Xem
	                                    	</a>&nbsp; &nbsp; &nbsp;
	                                    	@endif
	                                        <a href="{{ route('categories.edit', ['id' => $item->id]) }}" title="Sửa">
	                                            <i class="fa fa-pencil fa-fw"></i> Sửa
	                                        </a> &nbsp; &nbsp; &nbsp;
	                                        <a href="javascript:;" class="btn-destroy" data-href="{{ route('categories.destroy', $item->id) }}"
