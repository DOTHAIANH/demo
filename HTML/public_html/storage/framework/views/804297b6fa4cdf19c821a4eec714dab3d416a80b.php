...
<head>
    ...
    <style type="text/css">
        ...
        .page-tnam1 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/zenway.png")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .page-tnu1 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/begai.png")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .page-t2 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/chung.png")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .page-tnam3 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/nam.png")))); ?>');
            background-size:100% 100%;
            background-repeat:no-repeat;
        }

        .page-tnu3 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/nu.png")))); ?>');
            background-size:100% 100%;
            background-repeat:no-repeat;
        }
        ...
        /*.page-5 {
            background: no-repeat url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/pdf/img/bgpage5.png")))); ?>');
            background-size:100% 100%;
        }*/

        .pagetnam1 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/bgpage2.jpg")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .pagetnu1 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/bgpage3.jpg")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .paget2 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/bgpage4.jpg")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .pagetnam3 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/bgpage1.jpg")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }

        .pagetnu3 {
            background:url('data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/frontend/images/bgpage5.jpg")))); ?>');
            background-repeat:no-repeat;
            background-size:100% 100%;
        }
...
<body>
    <?php if($data['age'] < 13): ?>
        ...
        <?php endif; ?>
    <?php elseif($data['age'] > 12 && $data['age'] < 30): ?>
    <div class="page-1 page-t2 mg-page">
    <?php elseif($data['age'] > 29): ?>
        <?php if($data['sex'] == 1): ?>
        ...
        <?php endif; ?>
    <?php endif; ?> 
        <div class="author" style="height: 920px;"><p class="name"><?php echo $data_name; ?></p><p class="number"><?php echo e($data['consoduongdoi']); ?></p></div>
    ...
    <?php endif; ?> 
        ...
        <div class="row" style="text-align: center;">
            <div class="column2">
                <p style="color: #fff;"><?php echo $data_name; ?></p>
            </div>
            <div class="column2">
                <p style="color: #fff;"><?php echo e($data['day']); ?>/<?php echo e($data['month']); ?>/<?php echo e($data['year']); ?></p>
            </div>
        </div>
        <div class="row" style="text-align: center;">
            <div class="column3">
                <label style="color: #fff;"><?php echo e($data['thachthuc1']); ?></label>
                <div class="old">
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/old.png')))); ?>" alt="">
                    <span style="color: #fff;">0 -> 29 tuổi</span>
                </div>
                <label style="color: #fff;"><?php echo e($data['dinhcao1']); ?></label>
            </div>
            <div class="column3">
                <label style="color: #fff;"><?php echo e($data['thachthuc2']); ?></label>
                <div class="old">
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/old.png')))); ?>" alt="">
                    <span style="color: #fff;">30 -> 38 tuổi</span>
                </div>
                <label style="color: #fff;"><?php echo e($data['dinhcao2']); ?></label>
            </div>
            <div class="column3">
                <label style="color: #fff;"><?php echo e($data['thachthuc3']); ?></label>
                <div class="old">
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/old.png')))); ?>" alt="">
                    <span style="color: #fff;">39 -> 48 tuổi</span>
                </div>
                <label style="color: #fff;"><?php echo e($data['dinhcao3']); ?></label>
            </div>
            <div class="column3">
                <label style="color: #fff;"><?php echo e($data['thachthuc4']); ?></label>
                <div class="old">
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/old.png')))); ?>" alt="">
                    <span style="color: #fff;">49 -> 56 tuổi</span>
                </div>
                <label style="color: #fff;"><?php echo e($data['dinhcao4']); ?></label>
            </div>
        </div>
        <div class="row" style="text-align: center;">
            <div class="column">
                ...
                <table>
                    <tr>
                        ...
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consolinhhon']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Nội cảm</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['chisonoicam']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Tương tác</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consotinhcach']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Thái độ</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consosolap']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['ketnoinoitamvatinhcach']); ?></td>
                    </tr>
                </table>
            </div>
            <div class="column">
                ...
                <table>
                    <tr>
                        ...
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consoduongdoi']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Sứ mệnh</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['chisosumenh']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Ngày sinh</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consongaysinh']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Trưởng thành</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consotruongthanh']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Kết nối đường đời và Sứ mệnh</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['ketnoiduongdoivasumenh']); ?></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="column">
                ...
                <table>
                    <tr>
                        ...
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consobosung']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Cân bằng</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e(chisocanbang(str_slug(request('name'),' ', 'en'))); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Nợ nghiệp</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consononghiep']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Mức độ biểu hiện</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['chisomucdobieuhien']); ?></td>
                    </tr>
                </table>
            </div>
            <div class="column">
                ...
                <table>
                    <tr>
                        ...
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['consonamcanhan']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Tháng cá nhân</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['thangcanhan']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Đỉnh cao</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['dinhcao1']); ?>, <?php echo e($data['dinhcao2']); ?>, <?php echo e($data['dinhcao3']); ?>, <?php echo e($data['dinhcao4']); ?></td>
                    </tr>
                    <tr>
                        <td class="text" style="padding-left: 10px;color: #fff;">Thách thức chặng</td>
                        <td class="number" style="padding-left: 40px;width: 100px;color: #fff !important;"><?php echo e($data['thachthuc1']); ?>, <?php echo e($data['thachthuc2']); ?>, <?php echo e($data['thachthuc3']); ?>, <?php echo e($data['thachthuc4']); ?></td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="row" style="text-align: center;height: 430px;"> 
            <div class="column table-birthday">
                ...
                <table class="inner-border">
                    <tr class="inner-border-tr">
                        <td id="td3" class="local-number local-n-3 cell animated pulse infinite"><?php echo e(str_repeat("3",getnumber($data['full_number'],3))); ?></td>
                        <td id="td6" class="local-number local-n-6 cell animated pulse infinite"><?php echo e(str_repeat("6",getnumber($data['full_number'],6))); ?></td>
                        <td id="td9" class="local-number local-n-9 cell animated pulse infinite"><?php echo e(str_repeat("9",getnumber($data['full_number'],9))); ?></td>
                    </tr>
                    <tr class="inner-border-tr">
                        <td id="td2" class="local-number local-n-2 cell animated pulse infinite"><?php echo e(str_repeat("2",getnumber($data['full_number'],2))); ?></td>
                        <td id="td5" class="local-number local-n-5 cell animated pulse infinite"><?php echo e(str_repeat("5",getnumber($data['full_number'],5))); ?></td>
                        <td id="td8" class="local-number local-n-8 cell animated pulse infinite"><?php echo e(str_repeat("8",getnumber($data['full_number'],8))); ?></td>
                    </tr>
                    <tr class="inner-border-tr">
                        <td id="td1" class="local-number local-n-1 cell animated pulse infinite"><?php echo e(str_repeat("1",getnumber($data['full_number'],1))); ?></td>
                        <td id="td4" class="local-number local-n-4 cell animated pulse infinite"><?php echo e(str_repeat("4",getnumber($data['full_number'],4))); ?></td>
                        <td id="td7" class="local-number local-n-7 cell animated pulse infinite"><?php echo e(str_repeat("7",getnumber($data['full_number'],7))); ?></td>
                    </tr>
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr1.png')))); ?>" class="to-top-right arrow animated pulse infinite <?php echo e($data['stt_ns_th1'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-1 arrow animated pulse infinite <?php echo e($data['stt_ns_th2'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-2 arrow animated pulse infinite <?php echo e($data['stt_ns_th3'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-3 arrow animated pulse infinite <?php echo e($data['stt_ns_th4'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-1 arrow animated pulse infinite <?php echo e($data['stt_ns_th5'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-2 arrow animated pulse infinite <?php echo e($data['stt_ns_th6'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-3 arrow animated pulse infinite <?php echo e($data['stt_ns_th7'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr4.png')))); ?>" class="to-top-left arrow animated pulse infinite <?php echo e($data['stt_ns_th8'] == 1 ? '' : 'd-none'); ?>" />
                </table>
            </div>
            <div class="column table-name">
                ...
                <table class="inner-border">
                    <tr class="inner-border-tr">
                        <td id="tdt3" class="local-number local-n-3 cell animated pulse infinite"><?php echo e(str_repeat("3",getnumberName($data['full_name'],3))); ?></td>
                        <td id="tdt6" class="local-number local-n-6 cell animated pulse infinite"><?php echo e(str_repeat("6",getnumberName($data['full_name'],6))); ?></td>
                        <td id="tdt9" class="local-number local-n-9 cell animated pulse infinite"><?php echo e(str_repeat("9",getnumberName($data['full_name'],9))); ?></td>
                    </tr>
                    <tr class="inner-border-tr">
                        <td id="tdt2" class="local-number local-n-2 cell animated pulse infinite"><?php echo e(str_repeat("2",getnumberName($data['full_name'],2))); ?></td>
                        <td id="tdt5" class="local-number local-n-5 cell animated pulse infinite"><?php echo e(str_repeat("5",getnumberName($data['full_name'],5))); ?></td>
                        <td id="tdt8" class="local-number local-n-8 cell animated pulse infinite"><?php echo e(str_repeat("8",getnumberName($data['full_name'],8))); ?></td>
                    </tr>
                    <tr class="inner-border-tr">
                        <td id="tdt1" class="local-number local-n-1 cell animated pulse infinite"><?php echo e(str_repeat("1",getnumberName($data['full_name'],1))); ?></td>
                        <td id="tdt4" class="local-number local-n-4 cell animated pulse infinite"><?php echo e(str_repeat("4",getnumberName($data['full_name'],4))); ?></td>
                        <td id="tdt7" class="local-number local-n-7 cell animated pulse infinite"><?php echo e(str_repeat("7",getnumberName($data['full_name'],7))); ?></td>
                    </tr>
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr1.png')))); ?>" class="to-top-right arrow animated pulse infinite <?php echo e($data['stt_name_th1'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-1 arrow animated pulse infinite <?php echo e($data['stt_name_th2'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-2 arrow animated pulse infinite <?php echo e($data['stt_name_th3'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr2.png')))); ?>" class="to-right-all to-right-3 arrow animated pulse infinite <?php echo e($data['stt_name_th4'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-1 arrow animated pulse infinite <?php echo e($data['stt_name_th5'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-2 arrow animated pulse infinite <?php echo e($data['stt_name_th6'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr3.png')))); ?>" class="to-top-all to-top-3 arrow animated pulse infinite <?php echo e($data['stt_name_th7'] == 1 ? '' : 'd-none'); ?>" />
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/arr4.png')))); ?>" class="to-top-left arrow animated pulse infinite <?php echo e($data['stt_name_th8'] == 1 ? '' : 'd-none'); ?>" />
                </table>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số đường đời<br> <span class="c00000 size-number"><?php echo e($data['consoduongdoi']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image">
                                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/cschudao.png')))); ?>" alt="">
                                </li>
                            </ul>
                            <?php echo $data['duongdoi']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số sứ mệnh<br> <span class="c00000 size-number"><?php echo e($data['chisosumenh']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sosumenh.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['sumenh']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số kết nối đường đời và sứ mệnh<br> <span class="c00000 size-number"><?php echo e($data['ketnoiduongdoivasumenh']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <ul>
                            <li>
                            ...
                            <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/duongdoisumenh.png')))); ?>" alt=""></li>
                        </ul>
                        <?php echo $data['ketnoiduongdoivasumenh']; ?>   
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số trưởng thành<br> <span class="c00000 size-number"><?php echo e($data['consotruongthanh']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sotruongthanh.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['truongthanh']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số ngày sinh<br> <span class="c00000 size-number"><?php echo e($data['consongaysinh']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/songaysinh.png')))); ?>" alt=""></li>
                            </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số nội tâm<br> <span class="c00000 size-number"><?php echo e($data['consolinhhon']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sonoitam.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['sumenh']; ?>   
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số nội cảm<br> <span class="c00000 size-number"><?php echo e($data['chisonoicam']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sonoicam.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['noicam']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số kết nối nội tâm và tương tác<br> <span class="c00000 size-number"><?php echo e($data['ketnoinoitamvatinhcach']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <ul>
                            <li>
                            ...
                            <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/noitamtuongtac.png')))); ?>" alt=""></li>
                        </ul>
                        <?php echo $data['ketnoinoitamvatuongtac']; ?>   
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>SỐ TƯƠNG TÁC<br> <span class="c00000 size-number"><?php echo e($data['consotinhcach']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sotuongtac.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['tinhcach']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số thái độ<br> <span class="c00000 size-number"><?php echo e($data['consothaido']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sothaido.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['thaido']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số lặp<br> <span class="c00000 size-number"><?php echo e($data['consosolap']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/solap.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['solap']; ?>   
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Bổ sung<br> <span class="c00000 size-number"><?php echo e($data['consobosung']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <p>
                            ...
                            <p class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sobosung.png')))); ?>" alt=""></p>
                            <?php echo $data['bosung']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số cân bằng<br> <span class="c00000 size-number"><?php echo e($data['consocanbang']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/socanbang.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['canbang']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số nợ nghiệp<br> <span class="c00000 size-number"><?php echo e($data['consononghiep']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sononghiep.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['nonghiep']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số tháng cá nhân hiện tại  <?= date('m/Y'); ?><br> <span class="c00000 size-number"><?php echo e($data['thangcanhan']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sothangcanhan.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['contentthangcanhan']; ?>   
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="page-22 mg-page bg-page-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">                  
                    <div class="title-page-1">
                        <p>Số tháng cá nhân <?= date('m') == 12 ? '1/'.date('Y') : date('m/Y',strtotime('first day of +1 month')); ?><br> <span class="c00000 size-number"><?php echo e($data['thangcanhantiep']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <?php echo $data['contentthangcanhantiep']; ?>   
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-1">
                        <p>Số năm cá nhân <?= date('Y'); ?><br> <span class="c00000 size-number"><?php echo e($data['consonamcanhan']); ?></span></p>
                    </div>
                    <div class="content-page">
                        <div>
                            <ul>
                                ...
                                <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/sonamcanhan.png')))); ?>" alt=""></li>
                            </ul>
                            <?php echo $data['namcanhan']; ?>   
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="content-page">
                        <ul>
                            ...
                            <li class="box-image"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('frontend/pdf/img/duongdoithachthuc.png')))); ?>" alt=""></li>
                        </ul>
                    </div>
                    <div class="title-page-2">
                        <p>Đỉnh cao thứ nhất <span class="ffc000"><?php echo e($data['dinhcao1']); ?> , 0-29 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['condinhcao1']; ?>   
                    </div>
                    <div class="title-page-2">
                        <p>Đỉnh cao thứ hai <span class="ffc000"><?php echo e($data['dinhcao2']); ?> , 30-38 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['condinhcao2']; ?>   
                    </div>

                    <div class="title-page-2">
                        <p>Đỉnh cao thứ ba <span class="ffc000"><?php echo e($data['dinhcao3']); ?> , 39-48 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['condinhcao3']; ?>   
                    </div>

                    <div class="title-page-2">
                        <p>Đỉnh cao thứ tư <span class="ffc000"><?php echo e($data['dinhcao4']); ?> , 49-56 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['condinhcao4']; ?>   
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title-page-2">
                        <p>Thách thức thứ nhất <span class="ffc000"><?php echo e($data['thachthuc1']); ?> , 0-29 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['thachthucchang1']; ?>   
                    </div>
                    <div class="title-page-2">
                        <p>Thách thức thứ hai <span class="ffc000"><?php echo e($data['thachthuc2']); ?> , 30-38 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['thachthucchang2']; ?>   
                    </div>

                    <div class="title-page-2">
                        <p>Thách thức thứ ba <span class="ffc000"><?php echo e($data['thachthuc3']); ?> , 39-48 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['thachthucchang3']; ?>   
                    </div>

                    <div class="title-page-2">
                        <p>Thách thức thứ tư <span class="ffc000"><?php echo e($data['thachthuc4']); ?> , 49-56 tuổi</span></p>
                    </div>
                    <div class="content-page">
                        <?php echo $data['thachthucchang4']; ?>   
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /home/tuvi/domains/tuvi.tuvanweb.com/public_html/resources/views/frontend/page1.blade.php ENDPATH**/ ?>