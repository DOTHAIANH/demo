...
return [
    ...
    'philosopher' =>
        [
            'bold' => $distFontDir . '/Philosopher-Bold',
            'bold_italic' => $distFontDir . '/Philosopher-BoldItalic',
            'italic' => $distFontDir . '/Philosopher-Italic',
            'normal' => $distFontDir . '/Philosopher-Regular'
        ]
];