				...
				<table  cellpadding="0" cellspacing="0">
					<tr>
						<td valign="top">
							...
							<input type="radio" name="lock" value="1" <?php if($news['Order']['lock']==1) echo 'checked=""';?> /> <?php echo $languageProduct['Deactivate'];?> 
							<input type="radio" name="lock" value="0" <?php if($news['Order']['lock']==0) echo 'checked=""';?> /> <?php echo $languageProduct['Active'];?> 
