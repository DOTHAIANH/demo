...
<section class="body-section products-grid">
	<div class="title-wrapper">
		<h1>Phụ Tùng Ô Tô <?php echo $tmpVariable['category']['name'];?> Chính Hãng - PhutungotoToyota.com</h1>
...
<section class="body-section products-list">
	...
	<?php 
		...
		<div class="a-product wow fadeInUp wHighlight" data-wow-delay=".4s" data-prdid="<?php echo $news['Product']['id'];?>">
			<div class="row">
...
<?php
	if(!empty($tmpVariable['category']['sub'])){
		$linkManufacturer= getLinkManufacturer();
		echo '<section class="body-section products-grid">
				<h2>Phụ tùng ô tô chính hãng các dòng xe '.$tmpVariable['category']['name'].'</h2>
				<div class="row">';
				foreach($tmpVariable['category']['sub'] as $components){
