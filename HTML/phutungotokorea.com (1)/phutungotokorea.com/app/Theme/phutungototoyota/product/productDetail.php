...
<section class="body-section product-detail">
	...
	<div class="overview row">
		...
		<div class="price-order col-md-8 col-sm-12">
			...
			<p>Ngày cập nhập: <span itemprop="datePublished"><?php echo date('d/m/Y',$tmpVariable['data']['Product']['modified']->sec);?></span></p>
		...
		<div class="detail-info col-sm-12">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="soluoc">
					<ul class="custom-ulist" style="padding-left:0px;">
						...
						<p>
							Công ty TTC chuyên cung cấp "<b><i><?php echo $tmpVariable['data']['Product']['title'];?></i></b>" hàng xịn, chính hãng giá tốt nhất, nhập khẩu chính hãng, phân phối toàn quốc, uy tín, cam kết chất lượng.
							<br/>
							<p style="color:red;">
							Hãy sử dụng "<?php echo $tmpVariable['data']['Product']['title'];?>" để đảm bảo chất lượng đồng thời có được đầy đủ lợi ích từ hoạt động tin cậy tuyệt đối của xe. Sử dụng phụ tùng không chính hãng hoặc giả mạo đôi khi có thể gây ra những hậu quả đáng tiếc.
						</p>
							<b>HOTLINE: 0913.50.54.55</b>
							<br/>
							Để tra mã <a href="<?php echo $urlHomes;?>">Phụ tùng ô tô</a> vui lòng xem <a href="<?php echo $urlHomes;?>notices/tra-ma-phu-tung-o-to-chinh-xac-nhat.html">Tra mã phụ tùng ô tô</a>
						</p>
						</p>
						Bạn có thể tìm sản phẩm tại: <a href="<?php echo $urlHomes;?>">Phụ tùng ô tô Toyota</a> / <a href="<?php echo getLinkManufacturer().$tmpVariable['infoManufacturer']['slug'].'.html';?>">phụ tùng ô tô <?php echo $tmpVariable['infoManufacturer']['name'];?> </a>.
						</p>
					</ul>
				</div>
