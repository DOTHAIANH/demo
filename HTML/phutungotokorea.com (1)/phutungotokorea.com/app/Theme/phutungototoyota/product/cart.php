...
<section class="body-section products-grid">
			...
			<div class="table-responsive col-xs-12">
				...
				<table class="table table-bordered table-hover tablesorter">
					...
					<tbody>
						<?php
							$totalMoney= 0;
							if(count($tmpVariable['listOrderProduct'])>0){
								$number= 0;
								
								foreach($tmpVariable['listOrderProduct'] as $data)
								{
									$number++;
								...
								<tr>
									...
									<td>
										<?php 
											echo number_format($priceShow).' '.@$tmpVariable['listTypeMoney']['Option']['value']['allData'][$data['Product']['typeMoneyId']]['name'];
	...
	<div class="row">
		...
		<form class="custom-form form-horizontal" role="form" action="<?php echo $urlHomes.'saveOrderProduct_addOrder';?>" method="post">
			<input type="hidden" name="userId" value="<?php echo (isset($tmpVariable['infoUser']['User']['id']))?$tmpVariable['infoUser']['User']['id']:'';?>" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="fullname" name="fullname" placeholder="Tên đầy đủ" value="<?php echo (isset($tmpVariable['infoUser']['User']['fullname']))?$tmpVariable['infoUser']['User']['fullname']:'';?>" required>
				</div>
			</div>
			<div class="form-group">
				<label for="email" class="col-sm-2 control-label">Email<span class="form-require"> (*)</span></label>
				<div class="col-sm-10">
					<input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo (isset($tmpVariable['infoUser']['User']['email']))?$tmpVariable['infoUser']['User']['email']:'';?>" required>
				</div>
			</div>
			<div class="form-group">
				<label for="phone" class="col-sm-2 control-label">Điện thoại<span class="form-require"> (*)</span></label>
				<div class="col-sm-10">
					<input type="number" class="form-control" id="phone" name="phone" placeholder="Điện thoại" value="<?php echo (isset($tmpVariable['infoUser']['User']['phone']))?$tmpVariable['infoUser']['User']['phone']:'';?>" required>
				</div>
			</div>
			<div class="form-group">
				<label for="address" class="col-sm-2 control-label">Địa chỉ</label>
				<div class="col-sm-10">
					<textarea class="form-control" rows="3" name="address" placeholder="Địa chỉ giao hàng"><?php echo (isset($tmpVariable['infoUser']['User']['address']))?$tmpVariable['infoUser']['User']['address']:'';?></textarea>
				</div>
			</div>
			<div class="form-group">
