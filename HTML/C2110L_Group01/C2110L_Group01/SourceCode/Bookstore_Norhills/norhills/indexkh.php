...
<body>
    ...
    <header class="header"   style="background:#77B748">
        <div class="header__top">
            ...
            <div class="choose-registration"style="background-color:white">
                <a href="trangdangky.php" style="color:black">🆂🅸🅶🅽 🅸🅽</a>       
            </div>
                            </div>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__item set-bg" data-setbg="img/12.jpg">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>North Hills </h2>
                                <a href="#" class="primary-btn" style="background:green">Thiên đường của mọt sách</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero__item set-bg" data-setbg="img/h8.jpg">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>Làm cho cuộc sống của bạn trở nên đơn giản chỉ bằng cách đọc một cuốn sách!</h2>
                                <a href="#" class="primary-btn" style="background:green">Our Books</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        <div class="section-title">
                            <span style="color:green">About North Hills</span>
...
//                ?>
    ...
    <section class="class spad" style="background:#e2f9ed">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="class__form">
                        <div class="section-title">
                            <span style="color:green"> North Hills</span>
                            <h2>Hãy liên hệ cho chúng tôi <br /></h2>
                        </div>
                        <form action="#">
            ...
            <div class="class__video set-bg" data-setbg="img/dee.jpg">
            ...
            <div class="row">
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        <div class="section-title">
                            <span style="color:green">Theo dõi chúng tôi trên instagram</span>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <p class="copyright__text text-white"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script> KHÓA LUẬN TỐT NGHIỆP | NGUYÊN THỊ MINH THƯƠNG  &  HỒ THỊ PHƯƠNG</a>
