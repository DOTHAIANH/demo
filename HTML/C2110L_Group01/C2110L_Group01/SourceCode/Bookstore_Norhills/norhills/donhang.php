...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            ...
            <div class="homepage">
                  <div class="homepage" >
                  <h2 style="margin-left: 400px; color: GREEN; font-family:Playfair Display; font-weight:bold">ĐƠN HÀNG</h2>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px; margin-left: 20px;"> 
                    ...
                    $result = mysqli_query($conn,$sql);
                            ...
                            echo '<tr style="height: 60px;">
                                                    ...
                                                    <td style="text-align:center;"><a href=suadh.php?sid='.$row['madh'].'&sld='.$row['soluongdat'].'&mas='.$row['masach'].'&mactdh='.$row['mactdh'].'><input type="button" value="Sửa" style= "width: 50px;height: 30px;background: green;border:none;border-radius: 5px;color: #FAFAFA;"></td>
                             <td style="text-align:center;">';
                                                    if($row['tinhtrang']=='Chờ duyệt'){
                            echo'                       <a href=huydh.php?sid='.$row['madh'].'&sld='.$row['soluongdat'].'&mas='.$row['masach'].'&mactdh='.$row['mactdh'].'><input type="button" value="Hủy" style= "width: 50px;height: 30px;background: green;border:none;border-radius: 5px;color: #FAFAFA;"></td>';           
                                            }
                        echo'        </tr>';
                            }
                            }
