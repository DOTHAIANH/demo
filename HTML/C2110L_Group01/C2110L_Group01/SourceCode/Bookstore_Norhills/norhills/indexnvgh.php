...
<html lang="en">
  ...
  <div class="az-header" style="background-color:#66CCCC;  height:70px;">
      <div class="container" style="background-color:#66CCCC; height:70px; ">
        ...
        <div class="az-header-menu">
          <div class="az-header-menu-header">
            <a href="index.php" class="az-logo"><span></span> North HILLS</a>
    ...
    <div class="az-footer ht-40" style="background-color:#66CCCC">
