...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                  <h2 style="margin-left: 500px; color:#3b89de">TẤT CẢ ĐƠN HÀNG</h2>
                  <a href="dsdonhanght.php"><input style="width: 250px;
    height: 35px;
    background: #3b89de;
    border:none;
    margin-top: 20px;
    margin-bottom: 10px;
    border-radius: 15px;
    color: #FAFAFA;" type="button" value="Xem danh sách đơn hàng hoàn tất"></a>
    <a href="dsdonhangkn.php"><input style="width: 250px;
    height: 35px;
    background: #3b89de;
    border:none;
    margin-top: 20px;
    margin-bottom: 10px;
    border-radius: 15px;
    color: #FAFAFA;" type="button" value="Xem danh sách đơn hàng không nhận"></a>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    <tr>
                    <TD style=" width: 20px;height:50px;" ><b>MÃ ĐH</b></TD>
                    <TD style=" width: 150px;"><b>TÊN KHÁCH HÀNG</b></TD>
                    ...
                    <TD style="width: 70px;"><b>GỬI </b></TD>
                    <TD style="width: 90px;"><b>NGÀY ĐẶT</b></TD>
                    <TD style="width: 150px;" ><b>NGƯỜI GIAO</b></TD>
                    <TD style=""><b>TRẠNG THÁI</b></TD>
