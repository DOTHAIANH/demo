...
<html lang="en">
  ...
  <div class="az-header" style="background-color:#A9B7F6;  height:70px;">
      <div class="container" style="background-color:#A9B7F6; height:70px; ">
        <div class="az-header-left">
          <a href="index.php" class=""  style="font-size:28px;   font-weight:bold; color:black;"><span></span> ℕ𝕠𝕣𝕥𝕙 ℍ𝕀𝕃𝕃𝕊 </a>
        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a href="xemdsdonhangduyet.php" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i> Xem danh sách đơn hàng</a>
            </li>
            <li class="nav-item">
        ...
        <div class="az-header-right">
          ...
          <div class="dropdown az-profile-menu" style="width:50px">
            <a href="" class="az-img-user"><img src="./img/nvk.jpg" alt="" style="width:50px; height:45px;"></a>
            <div class="dropdown-menu">
