...
.dh tr:nth-child(1){
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                <Br>
                <h2 style="margin-left: 450px; color: #1c3e64">DANH SÁCH ĐƠN HÀNG HOÀN TẤT</h2>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    ...
                    $sql="SELECT * FROM khachhang inner join donhang on khachhang.makh=donhang.makh inner join nhanvien on donhang.manv=nhanvien.manv where tinhtrang ='Nhận hàng - Hoàn tất đơn hàng' ORDER BY tinhtrang ASC";
