  ...
  background-color: #717171;
    ...
    <body>
        ...
        <?php
            ...
            $sql="SELECT * FROM sach where noibat='co' and masach<'152'";
            $result = mysqli_query($link,$sql);
            echo '<table class="bangspnb"  width="100%" cellspacing = "0">';
            echo '<h3 class="spnoibat" style="font-family:times; padding-top:10px; color:green;"> SẢN PHẨM NỔI BẬT</h3>';
     ...
     echo'
                    ...
                    <p  style="color:red; text-align:center;font-size:18px; font-weight:bold;">'.$row['gia'].'VNĐ</p>
                </td>';
     ...
     echo'
                    <a href="sachnbvl.php"><input class="btspnoibat" type=button value="Xem thêm"  style="margin-left:40%; background:#46B48C;"></a>';
 }
