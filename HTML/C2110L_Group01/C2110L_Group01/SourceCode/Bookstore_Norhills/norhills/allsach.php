...
.curren-page{
    ...
    <body>
        <?php
            ...
            echo '<h2 class="spnoibat" style=" font-family: Playfair Display; font-weight:bold; color:green; margin-bottom:50px""> TẤT CẢ SÁCH</h2>';
...
//                '<TR><TD>'.$row['hinhanh'].'</TD><TD>'.$row['tensach'].'</TD></TR>';     
     ...
     echo'
                    ...
                    <p style="text-align:center; font-family: Playfair Display; font-weight:bold; color:red">'.$row['gia'].'VNĐ</p>
