        ...
        <div class="noidung">
            ...
            <div class="homepage">
                ...
                if(isset($_SESSION['status']))
                    {
                    echo '
                <h2 style="margin-left: 320px;margin-top: 20px; color: green;font-family:Playfair Display;">THÔNG TIN CÁ NHÂN</h2>
                <form method="POST" action="xuliupdatethongtinnd.php" style="margin-left: 250px; width: 500px; margin-top: 30px; font-family:Playfair Display; ">
                    <fieldset style="height:610px; border:1px solid green"> 
