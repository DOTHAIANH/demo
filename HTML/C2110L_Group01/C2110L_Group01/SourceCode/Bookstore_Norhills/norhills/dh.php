    ...
    font-size: 30px;">GIỎ HÀNG HIỆN TẠI</h1>
                <div class="entry" style="margin-left: 70px">
                    ...
                    <form action="xulictsachgh.php" method="POST">
                        ...
                        <?php
                    echo    '<a href="csthongtin.php?tong='.$tot.'" style="text-decoration: none; font-size:24px; color:#f46523"><input style="width: 140px;height: 35px;background: green;border:none;margin-left: 355px;margin-top: 10px;border-radius: 15px;color: #FAFAFA;" type="button" value="Đặt hàng"></a>'
                                ?>
                         <?php
                    echo    '<a href="guitang.php?tong='.$tot.'" style="text-decoration: none; font-size:24px; color:#f46523"><input style="width: 140px;height: 35px;background: green;border:none;margin-left: 355px;margin-top: 10px;border-radius: 15px;color: #FAFAFA;" type="button" value="Gửi tặng"></a>'
                                ?>
