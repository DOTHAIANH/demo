        ...
        <div class="noidung">
            ...
            <div class="homepage">
                ...
                if(isset($_SESSION['status']))
                    {
                    echo '
                <h2 style="margin-left: 340px;margin-top: 20px; color: green;padding-left:12px; padding-top:10px;  font-family:Playfair Display;">ĐỔI MẬT KHẨU</h2>
                <form method="POST" action="xulidoimk.php" style="margin-left: 280px; width: 500px; margin-top: 20px">
                    ...
                    <h4 style="margin-top: 20px; color: green; padding-top:10px; padding-bottom:5px; font-family:Playfair Display;" >Nhập mật khẩu mới</h4>
                    <input class="tx" id="mkm" type="password"  name="mkm" value="" placeholder="Nhập mật khẩu mới" style="width:90%;height:30px;" /></br>
                    </br><h4 style="margin-top: 20px; color: green; padding-top:10px; padding-bottom:5px; font-family:Playfair Display;">Nhập lại mật khẩu mới</h4>
