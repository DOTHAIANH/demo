            ...
            <div class="homepage" >
                  ...
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    ...
                    $result = mysqli_query($conn,$sql);
                            ...
                            <a href="luunvgh.php?id='.$row['madh'].'& sid='.$row12['manv'].'"><input type="submit" value="Lưu"  style=" width: 40px;height: 35px;background: GREEN;border:none;margin-top: 10px;color: #FAFAFA;"></a>
                                        </td>  
