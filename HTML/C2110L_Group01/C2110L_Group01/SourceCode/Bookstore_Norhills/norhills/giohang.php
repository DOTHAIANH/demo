                ...
                <div class="entry" style="margin-left: 70px">
                    ...
                    <form action="xulictsachgh.php" method="POST">
                        <table width="100%" border="0">
                                ...
                                <tr><td colspan="7"><hr style="border:1px Solid green;"></tr>
                        ...
                        ?>
                                <tr><td colspan="7"><hr style="border:1px Solid GREEN;"></tr>
                                                            ...
                                                            <tr><td colspan="7"><hr style="border:1px Solid green; margin-bottom: 20px;"></tr>
                </TABLE>
                        <input type="submit" value="Lưu"  style="margin-left: 355px; width: 140px;height: 35px;background: green;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br>
                    </form>      
                    <a href="sach.php"><input type="submit" value="Thêm sách"  style="margin-left: 355px; width: 140px;height: 35px;background:green;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br></a>
                    <a href="dh.php"><input type="submit" value="Đặt hàng"  style="margin-left: 355px; width: 140px;height: 35px;background: green;border:none;margin-top: 10px;border-radius: 15px;color: #FAFAFA;"> </br></a>
            </div>
            </div>
        </div>
        <div>
