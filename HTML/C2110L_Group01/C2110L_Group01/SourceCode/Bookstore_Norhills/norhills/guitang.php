...
<html>
                        ...
                        if(isset($_POST['ts']) and isset($_POST['sl']) and isset($_POST['id']) and isset($_POST['gia']))
	{
                    ...
                    echo '
                <h1 style="margin-left: 315px;margin-top: 10px; color: green">THÔNG TIN NGƯỜI NHẬN</h1>
                <form method="POST" style="margin-left: 280px; width: 500px; margin-top: 30px;">
                    <fieldset style="height:430px; border:1px solid green"> 
                    <h4 style="padding-left:20px; padding-top:20px;">Tên người nhận</h4></br>
                    <input class="tx" type="text" id="snd" name="tndcs" value="" placeholder="Tên người nhận" style="width:90%;height:30px; margin-left:30px;"  /></br></br>
                    <h4  style="padding-left:20px;">Địa chỉ người nhận</h4></br>
                    ...
                    <h4  style="padding-left:20px;">Số điện thoại người nhận</h4></br>
                    <input class="tx" type="tell" id="sdt" name="sdtcs" value="" placeholder="Số điện thoại người nhận" style="width:90%;height:30px;margin-left:30px;" /></br></br>
                    <h4  style="padding-left:20px;">Email người nhận</h4></br>
